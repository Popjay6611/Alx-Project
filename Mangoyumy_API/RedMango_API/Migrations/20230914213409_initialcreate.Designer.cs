...
namespace MangoyumyAPI.Migrations
{
    ...
    [Migration("20230914213409_initialcreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mangoyumy_API.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Mangoyumy_API.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mangoyumy_API.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mangoyumy_API.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("Mangoyumy_API.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mangoyumy_API.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mangoyumy_API.Models.CartItem", b =>
                {
                    b.HasOne("Mangoyumy_API.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mangoyumy_API.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Mangoyumy_API.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("Mangoyumy_API.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("Mangoyumy_API.Models.OrderHeader", b =>
                {
                    b.HasOne("Mangoyumy_API.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Mangoyumy_API.Models.ApplicationUser", null)
                        .WithMany()
